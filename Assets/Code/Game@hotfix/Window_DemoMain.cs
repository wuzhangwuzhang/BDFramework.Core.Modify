...
public class Window_DemoMain : AWindow
{
    ...
    [TransformPath("btn_1/Text")] private Text btnTxt;
...
//          //3.异步加载多个
        ...
        this.btn_08.onClick.AddListener(() => {
            BDebug.LogError("TODO:测试demo");
            ScreenViewManager.Inst.MainLayer.BeginNavTo("messageBox");
            BDebug.LogError(Time.deltaTime);
        });
    }
